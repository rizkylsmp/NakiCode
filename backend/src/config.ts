...
const envSchema = z.object({
  ...
  ADMIN_USERNAME: z
    .string()
    .min(1, "ADMIN_USERNAME is required — set a non-obvious username in .env"),
  ...
  PAYMENT_PROVIDER: z.enum(["dev", "midtrans", "xendit"]).default("dev"),
  ...
  CLOUDINARY_FOLDER: z.string().default("naki-code/designs"),
...
export const config = {
  ...
  payment: {
    ...
    midtransIsProduction: isProductionDeployment || env.MIDTRANS_IS_PRODUCTION,
  },
  storefront: {
